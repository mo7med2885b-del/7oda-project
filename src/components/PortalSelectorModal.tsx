...
export const PortalSelectorModal: React.FC<PortalSelectorModalProps> = ({ onSelectPortal }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#22262B]/95 backdrop-blur-xl flex items-center justify-center p-4 md:p-8 overflow-y-auto">
      <div className="w-full max-w-5xl rounded-3xl bg-[#2C3137] border border-[#6AB8FF]/30 shadow-[0_25px_70px_rgba(0,0,0,0.8)] p-8 md:p-12 space-y-10 text-center relative overflow-hidden">
        {/* Ambient Gradient Glow Effects */}
        <div className="absolute -top-32 -left-32 w-80 h-80 bg-[#2C3137]/40 rounded-full blur-3xl pointer-events-none"></div>
        <div className="absolute -bottom-32 -right-32 w-80 h-80 bg-[#6AB8FF]/20 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div className="relative z-10 flex flex-col items-center space-y-4">
          <div className="relative">
            <img
              ...
              className="w-24 h-24 md:w-28 md:h-28 rounded-3xl object-cover border-2 border-[#6AB8FF]/60 shadow-2xl"
            />
            <div className="absolute -bottom-2 -right-2 p-1.5 rounded-full bg-[#2C3137] border border-[#6AB8FF] text-[#6AB8FF] shadow">
          ...
          <div className="space-y-2 max-w-2xl">
            ...
            <p className="text-sm md:text-base text-[#6AB8FF] font-extrabold">
              {lang === 'ar'
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 text-left rtl:text-right">
          ...
          <div
            ...
            className="group cursor-pointer p-8 rounded-3xl bg-gradient-to-b from-[#22262B] to-[#22262B] border-2 border-[#2C3137] hover:border-[#6AB8FF] shadow-2xl transition-all duration-300 transform hover:-translate-y-2 space-y-6 flex flex-col justify-between"
          >
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="w-14 h-14 rounded-2xl bg-[#2C3137] flex items-center justify-center text-[#6AB8FF] font-black shadow-lg group-hover:scale-110 transition">
                  <Stethoscope className="w-7 h-7" />
                </div>
                <span className="px-3.5 py-1 rounded-full bg-[#6AB8FF]/20 text-[#6AB8FF] border border-[#6AB8FF]/40 text-xs font-mono font-bold uppercase tracking-wider">
                  {lang === 'ar' ? 'نمط الطبيب والإدارة' : 'Doctor Admin Portal'}
                </span>
              </div>

              <div>
                <h2 className="text-2xl font-black text-white group-hover:text-[#6AB8FF] transition">
              ...
              <ul className="space-y-2.5 text-xs text-slate-200 border-t border-white/10 pt-4">
                <li className="flex items-center gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#6AB8FF] shrink-0" />
            ...
            <button className="w-full py-4 rounded-2xl bg-[#2C3137] group-hover:bg-[#6AB8FF] group-hover:text-slate-950 text-white font-black text-sm transition shadow-xl flex items-center justify-center gap-2 mt-4">
          ...
          <div
            ...
            className="group cursor-pointer p-8 rounded-3xl bg-gradient-to-b from-[#044435] to-[#2C3137] border-2 border-emerald-500/40 hover:border-[#6AB8FF] shadow-2xl transition-all duration-300 transform hover:-translate-y-2 space-y-6 flex flex-col justify-between"
          >
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="w-14 h-14 rounded-2xl bg-[#6AB8FF]/20 flex items-center justify-center text-[#6AB8FF] font-black shadow-lg group-hover:scale-110 transition">
            ...
            <button className="w-full py-4 rounded-2xl bg-[#6AB8FF] text-slate-950 font-black text-sm transition shadow-xl flex items-center justify-center gap-2 mt-4 hover:bg-[#4FA5F5]">
