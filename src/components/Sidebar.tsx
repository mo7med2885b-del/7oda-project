...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, onOpenAiFinancialAdvisor }) => {
  ...
  return (
    <aside className="w-64 shrink-0 bg-white dark:bg-[#023326] border-r dark:border-[#00cb87]/20 border-[#e3ded5] p-4 flex flex-col justify-between min-h-[calc(100vh-61px)]">
      <div className="space-y-6">
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between px-3.5 py-3 rounded-2xl font-bold text-xs transition-all ${
                    isActive
                      ...
                      : 'text-[#122620] dark:text-slate-200 hover:bg-[#ece7de] dark:hover:bg-[#043e30] hover:text-[#00473e] dark:hover:text-white'
                  }`}
                >
                    ...
                    <span
                      className={`text-[10px] font-mono font-bold px-2 py-0.5 rounded-full ${
                        isActive
                          ...
                          : 'bg-[#ece7de] dark:bg-[#043e30] text-slate-600 dark:text-slate-300 border border-[#e3ded5] dark:border-[#00cb87]/20'
                      }`}
                    >
                      {item.badge}
                    </span>
        ...
        <div className="rounded-2xl p-4 bg-gradient-to-b from-[#00473e] to-[#023326] text-white shadow-xl relative overflow-hidden group border border-[#00cb87]/30">
